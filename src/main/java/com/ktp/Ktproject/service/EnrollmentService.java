...
public class EnrollmentService {
	...
	public ResponseEntity<ResponseStructure<Enrollment>> save(Enrollment e) {
	    ...
	    // 🔥 FETCH FULL ENTITIES
	    Students student = studentRepo.findById(e.getStudent().getId()).orElse(null);
	    Courses course = courseRepo.findById(e.getCourse().getId()).orElse(null);
	    Trainers trainer = trainerRepo.findById(e.getTrainer().getId()).orElse(null);
